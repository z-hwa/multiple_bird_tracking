...
data = dict(
    ...
    train=dict(
        type='DroneDataset',
        ann_file=
        '/root/Document/data/SMOT4SB/annotations/mixed_train_coco.json',
    ...
    val=dict(
        type='DroneDataset',
        ann_file=
        '/root/Document/data/MVA2023/train/annotations/split_val_coco.json',
        img_prefix='/root/Document/data/MVA2023/train/images/',
        pipeline=[
            dict(type='LoadImageFromFile', to_float32=True),
            dict(
                type='MultiScaleFlipAug',
...
work_dir = './work_dirs/cascade_rcnn_swin_rfla_smot4sb'
auto_resume = False
gpu_ids = [0]
