...
class RPN_DCNv3_Head(AnchorHead):
    """RPN head.
    ...
    def __init__(self,
        ...
        self.dcnv3_config = dcnv3_config if dcnv3_config is not None else {}
        super(RPN_DCNv3_Head, self).__init__(
    ...
    def forward_single(self, x):
        ...
        # DCNv3 的 input, output shape 是 (N, H, W, C)
        x = x.permute(0, 2, 3, 1)
        x = self.rpn_conv(x)
        x = x.permute(0, 3, 1, 2)
        # breakpoint()
    ...
    def loss(self,
        ...
        """
        losses = super(RPN_DCNv3_Head, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
    ...
    def onnx_export(self, x, img_metas):
        ...
        batch_bboxes, batch_scores = super(RPN_DCNv3_Head, self).onnx_export(
