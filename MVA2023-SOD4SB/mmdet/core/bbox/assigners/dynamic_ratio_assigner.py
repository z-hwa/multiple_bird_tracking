...
class DynamicRatioAssigner(BaseAssigner):
    ...
    def assign_wrt_overlaps(self, overlaps, gt_labels=None):
        ...
        # 2-0.
        # 使用設定比率的overlaps計算positive\negetive thr
        sorted_overlaps, _ = torch.sort(max_overlaps, descending=False)
        self.pos_iou_thr = sorted_overlaps[int(len(sorted_overlaps) * self.ratio)]
        self.neg_iou_thr = sorted_overlaps[int(len(sorted_overlaps) * self.ratio)]
