...
data = dict(
    train=dict(
        ...
        hard_negative_file=LIB_ROOT_DIR + '/work_dirs/cascade-rcnn_r50-fpn_140e_coco_finetune_NWD_wasserstein/train_coco_hard_negative.json',  # ---
...
load_from = LIB_ROOT_DIR + '/work_dirs/cascade-rcnn_r50-fpn_140e_coco_finetune_NWD_wasserstein/latest.pth'
