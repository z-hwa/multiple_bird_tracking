...
model = dict(
    ...
    train_cfg = dict(
        ...
        rcnn=[
            dict(
                assigner=dict(
                    type='StandaradDeviationIoUAssigner',
                    # pos_iou_thr=0.5,
                    # neg_iou_thr=0.5,
                    # min_pos_iou=0.5,
                    match_low_quality=False,
                    ignore_iof_thr=-1,
                    pos_lower_standard=0.5,
                    neg_upper_standard=0.5),
                sampler=dict(
                    type='RandomSampler',
                    num=512,
                    pos_fraction=0.25,
            ...
            dict(
                assigner=dict(
                    ...
                    match_low_quality=False,
                    ignore_iof_thr=-1,
                    pos_lower_standard=1,
                    neg_upper_standard=1),
                sampler=dict(
                    type='RandomSampler',
                    num=512,
                    pos_fraction=0.25,
            ...
            dict(
                assigner=dict(
                    ...
                    match_low_quality=False,
                    ignore_iof_thr=-1,
                    pos_lower_standard=1.5,
                    neg_upper_standard=1.5),
                sampler=dict(
                    type='RandomSampler',
                    num=512,
                    pos_fraction=0.25,
