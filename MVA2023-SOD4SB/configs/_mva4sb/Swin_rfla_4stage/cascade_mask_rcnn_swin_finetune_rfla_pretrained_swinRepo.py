_base_ = [
    '../../_base_/models/cascade_mask_rcnn_swin_fpn_nwd_forMM.py',
    './mva4sb.py',
...
pretrained="https://github.com/SwinTransformer/storage/releases/download/v1.0.2/cascade_mask_rcnn_swin_small_patch4_window7.pth"
...
resume_from = "work_dirs/cascade_mask_rcnn_swin_finetune_rfla_pretrained_swinRepo/epoch_23.pth"