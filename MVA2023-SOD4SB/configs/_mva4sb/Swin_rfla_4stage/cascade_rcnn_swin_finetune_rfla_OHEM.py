...
# load_from = "work_dirs/cascade_mask_rcnn_swin_finetune_rfla_4stage_08/epoch_137.pth"    # 載入過去最佳模型
resume_from = "work_dirs/cascade_rcnn_swin_finetune_rfla_OHEM/epoch_114.pth"