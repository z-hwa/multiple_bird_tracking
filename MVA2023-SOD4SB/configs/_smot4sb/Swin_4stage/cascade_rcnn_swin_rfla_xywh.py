...
model = dict(
    ...
    roi_head=dict(
        type='CascadeRoIHead',
        num_stages=6,
        stage_loss_weights=[2, 1.5, 1, 0.5, 0.25, 0.125],
        ...
        bbox_head=[
            ...
            dict(
                ...
                bbox_coder=dict(
                    type='DeltaXYWHBBoxCoder',
                    target_means=[0., 0., 0., 0.],
                    target_stds=[0.033, 0.033, 0.05, 0.05]),
                reg_class_agnostic=True,
                loss_cls=dict(
                    type='CrossEntropyLoss',
                    use_sigmoid=False,
...
optimizer = dict(type='SGD', lr=0.005, momentum=0.9, weight_decay=0.0001) # load from best 104e, set lr to 0.001
