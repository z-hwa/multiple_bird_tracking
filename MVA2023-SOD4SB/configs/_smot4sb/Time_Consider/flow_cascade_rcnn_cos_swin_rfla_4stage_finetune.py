...
load_from = "work_dirs/flow_cascade_rcnn_cos_swin_rfla_4stage/epoch_20.pth"
# resume_from = "work_dirs/flow_cascade_rcnn_cos_swin_rfla_4stage/epoch_10.pth"