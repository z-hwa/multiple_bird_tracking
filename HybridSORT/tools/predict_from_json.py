...
# pub test phase 2
output_dir = "Cascade_outputs/phase_2/best_TCM"  # 你可以自訂輸出資料夾
...
# val
# output_dir = "Cascade_outputs/val/best_TCM_hmiou"  # 你可以自訂輸出資料夾
# predictions_json_path = "../mva2023/" + "work_dirs/cascade_mask_rcnn_swin_finetune_rfla_4stage/results_smot4sb_val.bbox.json"
